...
abstract public class FitChartBaseFragment extends Fragment {
    protected final String TAG = getClass().getSimpleName();

//    final protected int STOCK_COLOR =  getContext().getResources().getColor(R.color.stock_color);
//    final protected int BOND_COLOR = getContext().getResources().getColor(R.color.bond_color);
//    final protected int ETC_COLOR = getContext().getResources().getColor(R.color.etc_color);
//    final protected int BG_COLOR = getContext().getResources().getColor(R.color.aim_white);
//    final protected int RISK_TXT_COLOR = getContext().getResources().getColor(R.color.chart_risk_txt_color);
...
//    }
    ...
    protected DecoView getDecoView() {
        ...
        try {
            return (DecoView) getView().findViewById(R.id.dynamic_arc_view);
